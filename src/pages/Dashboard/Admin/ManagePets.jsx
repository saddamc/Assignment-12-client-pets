...
const ManagePets = () => {
    ...
    return (
        <>
        <Helmet> 
        <title>Manage Pets | Dashboard</title>
      </Helmet>
             ...
             <div className="flex gap-12  mb-8 items-center  py-4 font-bold">
                <div className="flex  w-4/12 gap-24 bg-slate-100 shadow-md p-4 rounded-lg  ">
                    <div className="w-3/12 text-white ">
                        <p className="px-4 py-3 bg-green-500 rounded-lg shadow-lg font-bold text-xl"><SiPetsathome /> </p>
                    </div>
                    <div className="w-9/12 text-center">
                        <h2 className="text-lg opacity-50">Total Pets  </h2>
